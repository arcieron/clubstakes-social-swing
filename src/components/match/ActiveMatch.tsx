...
import { ArrowLeft, Users, Trophy, MapPin, Calendar, UserPlus } from 'lucide-react';
import { Scorecard } from './Scorecard';
import { AddPlayersToMatch } from './AddPlayersToMatch';
        ...
        <div className="max-w-4xl mx-auto p-4">
          ...
          <div className="flex items-center gap-3 mb-4 sticky top-4 z-10">
            ...
            <div className="bg-white rounded-lg shadow-sm border px-4 py-2 flex-1">
              <h1 className="font-bold text-gray-800">Manage Players</h1>
              <p className="text-sm text-gray-500">{match.courses?.name || 'Golf Match'}</p>
            </div>
          </div>
        ...
        {players.length === 0 ? (
          <Card className="text-center py-8">
            <CardContent>
              ...
              <p className="text-gray-600 mb-4">Add players to start the match</p>
